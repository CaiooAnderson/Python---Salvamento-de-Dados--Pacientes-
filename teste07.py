...
while continuar:
    ...
    if menu.lower() == '4':
        print("Salvando...")
        caminho_arquivo = os.path.join(os.getcwd(), "documentos", f"tabela_{data}.txt")
        with open('pacientes.csv', 'w') as arquivo:
...
# salvamento em csv, porém não está salvando a última atualização da tabela (paciente).